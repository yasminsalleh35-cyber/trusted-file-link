...
-- Using TEXT instead of the enum type to avoid type issues
CREATE OR REPLACE FUNCTION create_user_profile(
  user_id UUID,
  user_email TEXT,
  user_full_name TEXT,
  user_role TEXT, -- Using TEXT instead of enum
...
BEGIN
  ...
  VALUES (
    ...
    user_email,
    user_full_name,
    user_role::text, -- Cast to text, let PostgreSQL handle the conversion
    user_client_id,
    NOW(),
    NOW()
  )
